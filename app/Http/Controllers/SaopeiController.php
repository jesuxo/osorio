...
class SaopeiController extends Controller
{
    ...
    public function descargarnew(Request $request)
    {
        $sucursalid = str_replace("300","",$request->sucursal);
            ...
            foreach ($depositos as $deposito){
                if($deposito != ''){
                    ...
                    $saopei =  Saopei::selectRaw('id, NumeroD, fk_sucursal, tipoopi,
                                                  ...
                                                  UsoMat,Notas1,Notas2,Notas3')
                                      ->whereRaw("codubic2 = '$deposito'
                                                  and descargar = 1
                                                  and tipoopi = 'S'
                    ...
                    if($saopei){
                        ...
                        $saitemopi = Saitemopi::where([
                            'NumeroD'    => $saopei->NumeroD,
                            'fk_sucursal'=> $saopei->fk_sucursal,
                            'tipoopi'    => $saopei->tipoopi
                        ])->get();
