...
class Pagare extends Model
{
    ...
    protected $fillable = [
        'fecha', 'codclie', 'fechapagar', 'nombreavalista',
        'cedulaavalista',  'domicilioavalista',
        'fk_usuario', 'monto'
    ];

    protected $appends = ['fechapagarformat','fechaformat', 'montopagare', 'diapagar', 'monpagar', 'yearpagar'];
    ...
    public function getMontopagareAttribute(){
        $monto = $this->monto;
    ...
    public function getDiapagarAttribute(){
        list($y,$i,$d) = explode('-',$this->fechapagar);
        $obj = new NumeroALetras();
