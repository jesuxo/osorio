    ...
    if(this.responseText){
        ...
        Array.from(json_records).forEach(function (element) {
            ...
            Invoices.push( {
                ...
                sucursal      : (element.sucursal)   ? element.sucursal    : 0,
...
function loaddata() {
    ...
    Array.from(Invoices).forEach(function (raw) {
        ...
        var tableRawData = `<tr class="tr` + raw.id + `">
                ...
                <td class="sucursal">` + raw.sucursal + `</td>
                ...
                <td>
                 ...
                 if(raw.status == 0){
                     tableRawData = tableRawData +
                         `  <li>
                                <a class="dropdown-item" target="_blank" href="` + raw.telefono + `">
...
`;
        ...
        tableRawData = tableRawData +   `
            ...
            <tr class="tr` + raw.id + `">
             <td class="titular" colspan="8" style="font-size: 11px; color: darkgray;">
