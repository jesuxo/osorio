            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nuevo Camión</li>
                    </ol>
                </nav>
                <h1 class="h3 mb-0 text-gray-800">
                    <i class="bi bi-plus-circle me-2"></i>Registrar Nuevo Camión
                </h1>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('camiones.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Formato: ABC-123</small>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('tipo') is-invalid @enderror"
                                ...
                                <option value="propio" {{ old('tipo') == 'propio' ? 'selected' : '' }}>Propio</option>
                                <option value="alquilado" {{ old('tipo') == 'alquilado' ? 'selected' : '' }}>Alquilado</option>
                            </select>
                            @error('tipo')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3 d-none" id="costo-alquiler-container">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Información adicional relevante sobre el camión</small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-2"></i>Guardar Camión
                        </button>
                    </div>
                </form>
            </div>
