        ...
        <div class=" row ">
            <div class="card card-height-100">
                <div class="card-header align-items-center text-center d-flex justify-content-between">
                    <h4 class="card-title text-start mb-0 flex-grow-1">  EXISTENCIAS POR MARCAS</h4>
                    @if($ajax == 0)
                        <script>window.print()</script>
                    @else
                         <a target="_blank" href="/existencia/motos/modelos/{{$inspadre}}"><i class="bi bi-printer" style="margin-right: 5px"></i> Imprimir</a>
                    @endif
                </div>
