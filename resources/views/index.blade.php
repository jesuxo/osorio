...
@section('content')
    ...
    <div class="row g-4 mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <a href="/newexistencias" class="stretched-link text-decoration-none">
                                <div class="mt-3 text-muted small">
        ...
        @if(Auth::user() and auth()->user()->can('menu_pedidomotos') and session('comercialid') == 1)
            <div class="col-xl-3 col-md-6">
                <div class="card dashboard-card">
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div>
                                <div class="stat-label">Motos Prepagadas</div>
                                <a href="/pagos-proveedores" class="stretched-link text-decoration-none">
                                    <div class="mt-3 text-muted small">
                            ...
                            <div class="card-icon-wrapper bg-soft-warning">
                                <i class="ri-motorbike-fill fs-3 text-warning"></i>
                            </div>
                        </div>
    ...
    <div class="row g-4  ">
        <div class="col-lg-4">
            <div class="card dashboard-card  ">
                ...
                <div class="card-footer bg-transparent border-0">
                    <a href="/reporte/motos" class="btn btn-outline-primary w-100">
                        Ver ventas de motos
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card dashboard-card ">
                ...
                <div class="card-footer bg-transparent border-0">
                    <a href="reporte/lubricantes" class="btn btn-outline-secondary w-100">
                        Ver venta de lubricantes
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card dashboard-card  ">
                ...
                <div class="card-footer bg-transparent border-0">
                    <a href="/reporte/repuestos" class="btn btn-outline-primary w-100">
                        Ver ventas de repuestos
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4  ">
        <div class="col-lg-4">
            <div class="card dashboard-card  ">
                ...
                <div class="card-footer bg-transparent border-0">
                    <a href="/reporte/compra/motos" class="btn btn-outline-primary w-100">
                        Ver cantidades compradas
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card dashboard-card  ">
                <div class="card-header bg-transparent border-0">
                    <h5 class="section-title mb-0">
                        <i class="ri-cellphone-fill text-warning"></i>
                        Existencias de motos
                    </h5>
                </div>
            ...
            <div class="quick-actions">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="/transferencias/create" class="quick-action-btn">
                        <i class="ri-product-hunt-line"></i> Nueva transferencia
                    </a>
                    ...
                    @endif
                    @if(Auth::user() and auth()->user()->can('menu_financiamiento'))
                        <a href="/simulacionFinanciamiento" class="quick-action-btn">
                            <i class="ri-motorbike-fill"></i>Simulacion Financiamiento
                        </a>
                    @endif
                    <a href="/seriales/historial" class="quick-action-btn">
                        <i class="ri-motorbike-fill"></i>Historial Serial
                    </a>
                </div>
            </div>
        </div>
        ...
        <script>
                    ...
                    <div class="card h-100 border-hover shadow-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <span class="badge ${sucursal.tipo === 'Z' ? 'bg-success' : 'bg-warning'}">
                                    ${sucursal.tipo === 'Z' ? 'Fac' : 'Dev'} ${sucursal.numerod}
                                </span>
                            </div>
            ...
            `;
                ...
                `;
                    ...
                    modalTitle.innerHTML = `<i class="ri-file-copy-line"></i> Documento ${tipo === 'Z' ? 'Factura' : 'Devolución'} N° ${numero}`;
            ...
            `;
                ...
                // Eventos
                btnBuscar.addEventListener('click', () => buscarFacturabuscarFactura('Z'));
                btnBuscarDevolucion.addEventListener('click', () => buscarFactura('w'));
