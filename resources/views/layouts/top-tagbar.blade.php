<div class="top-tagbar" style="display: none">
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-4 col-6 d-none d-xxl-block">
                <div class="d-flex align-items-center justify-content-center gap-3 fs-14 fw-medium">
                    <div>
                        <i class="bi bi-envelope align-middle me-2"></i> support@mail.com
                    </div>
                    <div>
                        <i class="bi bi-globe align-middle me-2"></i> www.wwww.com
                    </div>
                </div>
            </div>
