    ...
    <form id="editproduct-form" autocomplete="off" class="needs-validation" method="post"
        ...
        <div class="row">
                ...
                <div class="card "  >
                    ...
                    <div class="card-body">
                        ...
                        <div class="row ">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="peso" value="{{$producto->peso}}"
                                           placeholder="Ej: 2 ">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" style="z-index: 1;">
                                        <input type="text" class="form-control" placeholder="Ej: 100" id="volumen" name="volumen"
                                               aria-label="volumen"  value="{{$producto->volumen}}"  aria-describedby="volumen">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cantxempaq" name="cantxempaq" value="{{$producto->cantxempaq}}"
                                           placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                                    <input type="checkbox" class="form-check-input" id="preciodolarfijo" name="preciodolarfijo" {{($producto->preciodolarfijo)?'checked':''}}    value="1">
            ...
            <div class="col-xl-3 col-lg-4">
                ...
                @if(Auth::user()  and auth()->user()->can('menu_productos_modificar_precios') )
                    <div class="card"  >
                        <div class="card-header">
