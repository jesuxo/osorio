...
@section('title')
    Reporte de Ventas de Lubricantes por Sucursal
@endsection
...
@section('css')
    <style>
        ...
        .card-header-lubricantes {
            background-color: #0072c5;
            color: white;
        }

        .card-header-lubricantes h4 {
            color: white !important;
        }

        .card-header-lubricantes small {
            color: rgba(255, 255, 255, 0.8);
        }

        .btn-outline-lubricantes {
            background: transparent;
            border: 1px solid #0072c5;
            color: #0072c5;
        }

        .btn-outline-lubricantes:hover {
            background: #0072c5;
            color: white;
        }
    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <ul class="nav nav-pills flex-grow-1 mb-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" onclick="tabchangeto('1')" href="javascript:;" role="tab" id="tab1">
                            <i class="bi bi-droplet"></i> Lubricantes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" onclick="tabchangeto('2')" href="javascript:;" role="tab" id="tab2">
                            <i class="bi bi-grid-3x3-gap-fill"></i> Áreas de Lubricantes
                        </a>
                    </li>
                    @php
                        $ii = 3;
            ...
            <div class="tab-content">
                {{-- Pestaña 1: Lubricantes --}}
                <div class="tab-pane active" id="tabcontent1" role="tabpanel">
                    <div class="card">
                        <div class="card-header card-header-lubricantes">
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary me-2" onclick="exportarExcel('tablaLubricantes')">
                        ...
                        <div class="card-body" style="padding: 10px 0;">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-lubricantes" id="tablaLubricantes">
                                    <thead>
                                    <tr>
                                        <th class="text-start" style="min-width: 200px;">LUBRICANTE</th>
                ...
                {{-- Pestaña 2: Áreas de Lubricantes --}}
                <div class="tab-pane" id="tabcontent2" role="tabpanel">
                    <div class="card">
                        <div class="card-header card-header-lubricantes">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title mb-0 flex-grow-1" style="color: #0072c5 !important;">
                                    Lubricantes Vendidos por Área
                                    <small class="text-muted small"><i class="bi bi-calendar-range"></i> {{ str_replace('to', ' al ', $fechasreport) }}</small>
                                </h4>
                                <button type="button" class="btn btn-sm btn-outline-primary me-2" onclick="exportarExcel('tablaAreaLubricantes')">
                                    <i class="bi bi-file-excel"></i> Exportar
                                </button>
                            </div>
                        </div>
                        <div class="card-body" style="padding: 10px 0;">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-lubricantes" id="tablaAreaLubricantes">
                                    <thead>
                                    <tr>
                    ...
                    @if($oper['montovta'] > 0 && isset($oper['descrip']) && $oper['descrip'] != '')
                        <div class="tab-pane" id="tabcontent{{ $ii }}" role="tabpanel">
                            <div class="card">
                                ...
                                <div class="card-body" style="padding: 10px 0;">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-lubricantes" id="tablaOperador{{ $ii }}">
                                            <thead>
                                            <tr>
                                                <th class="text-start" style="min-width: 200px;">LUBRICANTE</th>
                                                @foreach($sucursales as $indexsucu => $sucursal)
                                            ...
                                            @if(isset($productos))
                                                @foreach($arrayprods as $indexprd => $item)
                                                    ...
                                                    <tr class="{{ $loop->even ? 'table-light' : '' }}">
                                                        <td class="text-start">
                                                            {{ isset($productos[$item['codprod']]) ? $productos[$item['codprod']] : '' }}
                                                        </td>
                                                        @foreach($sucursales as $indexsucu => $sucursal)
                                                            @php
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" name="form1" id="form1" action="/reporte/lubricantes">
                        @csrf
                        @method('POST')
...
@section('scripts')
    ...
    <script>
        ...
        function exportarExcel(tableId) {
            ...
            link.setAttribute('download', 'reporte_lubricantes.xls');
