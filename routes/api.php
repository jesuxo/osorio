...
Route::group([ 'middleware' => 'check.user'], function () {
    ...
    Route::controller(\App\Http\Controllers\SaprodController::class)->group(function () {
        ...
        Route::post('saprod/get/newlistprodubic', 'newlistprodubic');
        Route::post('saprod/get/listprodubic', 'listprodubic');
        Route::post('saprod/get/newproductosinstsancias', 'newproductosinstsancias');
        Route::post('saprod/get/productosinstsancias', 'productosinstsancias');
        Route::post('saprod/get/productosinstsanciasnew', 'productosinstsanciasnew');
        Route::post('saprod/get/productosallinstsanciasnew', 'productosallinstsanciasnew');
    ...
    Route::controller(\App\Http\Controllers\SaopeiController::class)->group(function () {
        ...
        Route::post('saopei/sync/descargarnew', 'descargarnew');
